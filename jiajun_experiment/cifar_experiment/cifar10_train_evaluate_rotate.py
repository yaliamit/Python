...
batch_size = 400
train_dir = '/home/jiajun/MultipleDetection/cifar10_yali_2/cifar10_theano_evaluate_rotation_train_adam'
max_steps = 500000
validation = False
validation_model = ''
...
def train():
    ...
    for step in xrange(max_steps):
        ...
        if step % 1000 == 0 or (step + 1) == max_steps:
            ...
            _, test_image, test_label = cifar10_data.test.next_eval_batch(batch_size)
            total_acc_count = 0
            total_count = 0
        ...
        train_image, _, train_label = cifar10_data.train.next_batch(batch_size)
