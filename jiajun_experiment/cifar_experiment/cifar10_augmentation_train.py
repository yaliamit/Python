...
batch_size = 400
train_dir = '/home/jiajun/MultipleDetection/cifar10_yali_2/cifar10_theano_augment_train_adam'
max_steps = 500000
validation = False
validation_model = ''
...
def train():
    ...
    for step in xrange(max_steps):
        ...
        _, train_image, train_label = cifar10_data.train.next_batch(batch_size)
