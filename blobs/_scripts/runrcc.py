...
if 'loc' in outname:
    ...
    f.write(ss+'\n')
    f.close()
    commands.check_output("scp _scripts/runthings yaliamit@rcc.uchicago.edu:Desktop/Dropbox/Python/blobs/_scripts/.",shell=True)


    os.system('ssh yaliamit@midway2.rcc.uchicago.edu \'cd Desktop/Dropbox/Python/blobs/; sbatch TF.sbatch \' & ')
    ...
    while (ny != ''):
        time.sleep(10)
        try:
            ss = commands.check_output('scp yaliamit@midway2.rcc.uchicago.edu:Desktop/Dropbox/Python/blobs/' +
    ...
    while (not done):
        ...
        try:
            commands.check_output('scp yaliamit@midway2.rcc.uchicago.edu:Desktop/Dropbox/Python/blobs/' + OUTNAME + ' ' + lOUTNAME,
                            shell=True)
        except:
            print('copy failed')
