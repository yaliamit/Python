...
def process_args(parser):
    ...
    parser.add_argument('--T', type=int, default=[0, 4], help='pooling')
    parser.add_argument('--S', type=int, default=[0, 2, 4, 6], help='pooling')
    parser.add_argument('--Z', type=float, default=[.8,1.2], help='pooling')
