...
def get_train(NETPARS):
    ...
    if (NETPARS['data_set']=='mnist'):
        ...
        X_train, y_train, X_val, y_val, X_test, y_test = cifar.load_dataset(NETPARS['data_set'],Train=NETPARS['train'],white=False,num_val=num_val)
