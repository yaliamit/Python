...
class NewDenseLayer(Layer):
    ...
    def __init__(self, incoming, num_units, W=init.GlorotUniform(), R=init.GlorotUniform(),
        ...
        self.Rzero=self.add_param(Rzero,(num_inputs,num_units),name="Wzero", trainable=False)
    ...
    def get_output_for(self, input, **kwargs):
        ...
        activation = newdot_new.newdot(input, self.W,self.R, self.prob, self.Wzero, self.Rzero)
