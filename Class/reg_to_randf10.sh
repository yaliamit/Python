...
ssh yaliamit@linux2.cs.uchicago.edu "mv Desktop/Dropbox/Python/Class/_BP_CIFAR10/junk Desktop/Dropbox/Python/Class/_BP_CIFAR10/igor2f_s_1.txt"
python runfas.py net=_BP_CIFAR10/igor2f_s mult=2 start=1 use_existing=True write_sparse=True train=False igor2f_s_2_OUT
#python runfas.py net=_BP_CIFAR10/spigor2f_s_2 start=1 mult=2 use_existing=True write_sparse=False train=False spf_testOUT
