...
#python runfas.py net=_BP_CIFAR10/spigor2f_s start=2 mult=3 use_existing=True write_sparse=False train=False spigor2f_s_2_testOUT
python runfas.py net=_BP_CIFAR10/spigor2f_s_2 start=1 mult=1 use_existing=True write_sparse=False mod_net=trymod_randf eta_current=.1 eta_init=.1 num_epochs=200 spigor2f_s_2_0_.OUT
#python runrcc.py net=_BP_CIFAR10/spigor2f_s_2 start=2 mult=3 num_epochs=100 use_existing=True write_sparse=False eta_current=.001 eta_init=.001 spigor2f_s_3_1_OUT
