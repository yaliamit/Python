...
#python runfas.py net=_BP_CIFAR100/igor2g_s eta_init=.001 eta_current=.001 num_epochs=100 igor2g_s_OUT
...
ssh yaliamit@linux2.cs.uchicago.edu "sed 's/conv4/conv4S/g' Desktop/Dropbox/Python/Class/_BP_CIFAR100/igor2g_s_1_2.txt > Desktop/Dropbox/Python/Class/_BP_CIFAR100/junk"
ssh yaliamit@linux2.cs.uchicago.edu "cp Desktop/Dropbox/Python/Class/_BP_CIFAR100/junk Desktop/Dropbox/Python/Class/_BP_CIFAR100/igor2g_s_1_2.txt"
python runfas.py net=_BP_CIFAR100/igor2g_s_1 mult=3 start=2 use_existing=True write_sparse=True train=False igor2g_s_1_3_OUT
python runfas.py net=_BP_CIFAR100/spigor2g_s_1 start=2 mult=3 use_existing=True write_sparse=False train=False spigor2g_s_1_3_testOUT
# Remove top 2 layers and replace with R layers update top 3 layers, sparse + 2 Rdense.
python runfas.py net=_BP_CIFAR100/spigor2g_s_1 mult=3 start=2 use_existing=1 write_sparse=False num_epochs=100 spigor2g_s_1_3_OUT