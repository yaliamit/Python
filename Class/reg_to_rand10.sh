python runrcc.py net=_BP_CIFAR10/igor2f_s eta_init=.001 eta_current=.001 igor2f_s
...
python runrcc.py net=_BP_CIFAR10/igor2f_s_2 mult=1 start=1 use_existing=1 mod_net=trymod_randf igor2f_s_2_OUT
...
python runrcc.py net=_BP_CIFAR100/spigor2f_s_2 start=1 mult=2 use_existing=True write_sparse=False eta_current=.1 eta_init=.1 num_epochs=50 spigor2f_s_2_1_OUT
