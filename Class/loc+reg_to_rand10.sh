python runrcc.py net=_BP_CIFAR10/igor2Q_s eta_init=.001 eta_current=.001 igor2Q_s_OUT
...
python runrcc.py net=_BP_CIFAQ10/spigor2Q_s start=2 mult=3 use_existing=True write_sparse=False train=False sp_loc_testOUT
