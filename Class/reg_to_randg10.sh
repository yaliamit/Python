...
python runrcc.py net=_BP_CIFAR10/igor2g_s mult=2 start=1 use_existing=True write_sparse=True train=False igor2g_s_1_0_0_OUT
python runrcc.py net=_BP_CIFAR10/spigor2g_s start=1 mult=2 use_existing=True write_sparse=False train=False spigor2g_s_1_0_0_testOUT
# Remove top 2 layers and replace with R layers for a few steps.
python runrcc.py net=_BP_CIFAR10/spigor2g_s_2 mult=1 start=1 use_existing=1 mod_net=trymod_randg num_epochs=50 igor2g_s_1_0_OUT
