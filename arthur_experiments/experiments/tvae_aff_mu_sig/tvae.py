...
# TVAE with diagonal normal prior (unknown mu, unknown diagonal Sigma) 
# on the affine transformation (6 degrees of freedom)
...
def build_model(input_var=None, input_shape=(None, ), n_latent=2,
    ...
    sigma_default = np.array(6 * [0], dtype="float32")
    ...
    mu_spatial = u_mu_pr_net.b + np.array([1, 0, 0, 0, 1, 0], dtype="float32")
...
def build_transf_var_autoencoder(input_var=None, input_shape=(None, ),
    ...
    prior_input = lasagne.layers.InputLayer(shape=(6,),
        input_var=input_sig)
